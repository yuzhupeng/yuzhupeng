/\* ===== SVG 图解颜色变量（浅色背景） ===== \*/ :root { --c-gray-fill:#f0eeea; --c-gray-s:#888780; --c-gray-t:#2c2c2a; --c-teal-fill:#e0f4ee; --c-teal-s:#0f6e56; --c-teal-t:#085041; --c-purple-fill:#eeedfe;--c-purple-s:#534ab7;--c-purple-t:#3c3489; --c-coral-fill:#faece7;--c-coral-s:#993c1d;--c-coral-t:#712b13; --c-amber-fill:#faeeda;--c-amber-s:#854f0b;--c-amber-t:#633806; --c-blue-fill:#e6f1fb; --c-blue-s:#185fa5; --c-blue-t:#0c447c; --c-green-fill:#eaf3de;--c-green-s:#3b6d11;--c-green-t:#27500a; --arr: #888780; --dash: #b8b6ae; --text-3: #8a8780; --border-2: #c8c6bc; } /\* ===== SVG 共享样式类 ===== \*/ svg .th{font-family:sans-serif;font-size:14px;font-weight:500;} svg .ts{font-family:sans-serif;font-size:12px;font-weight:400;} svg .arr-line{fill:none;stroke:var(--arr);stroke-width:1.5;} svg .dash-line{fill:none;stroke:var(--dash);stroke-width:1.2;stroke-dasharray:5 4;} /\* ===== 图解容器 ===== \*/ .diagram{background:#fafaf8;border:1px solid #e4e2da;border-radius:12px;padding:24px 16px 16px;margin:28px 0;overflow-x:auto;} .diagram-title{font-family:sans-serif;font-size:12px;text-transform:uppercase;letter-spacing:.07em;color:#8a8780;margin-bottom:16px;text-align:center;} /\* ===== 标签徽章 ===== \*/ .badge{display:inline-block;font-family:sans-serif;font-size:11px;font-weight:500;padding:3px 9px;border-radius:12px;margin:0 4px 4px 0;vertical-align:middle;} .badge-easy{background:var(--c-teal-fill);color:var(--c-teal-t);border:1px solid var(--c-teal-s);} .badge-prod{background:var(--c-purple-fill);color:var(--c-purple-t);border:1px solid var(--c-purple-s);} .badge-adv{background:var(--c-coral-fill);color:var(--c-coral-t);border:1px solid var(--c-coral-s);}
